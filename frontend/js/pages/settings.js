  ...
  render(container) {
    container.innerHTML = `
      <div class="page-placeholder">
        ...
        <div class="page-placeholder-title">Settings</div>
        <div class="page-placeholder-desc">System configuration and admin settings coming soon.</div>
      </div>
    `;
  },
};
...
Router.register("settings", {
  render: (container) => SettingsPage.render(container),
});
